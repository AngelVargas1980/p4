...
<section>
    ...
    <div class="sidebar">
        <h1 class="logo">TRANSPORTES VARGAS</h1>

        <! –” Opciones de la barra lateral"–>


        <ul class="nav">
            <li class="active"><a href=""><i class=""></i> Inicio/login/Registro</a></li>
            <li><a href="/indext" ><i class=""></i> Transporte</a></li>
            <li><a href="/indexc"><i class=""></i> Camion</a></li>
            <li><a href="/index"><i class=""></i> Piloto</a></li>
            <li><a href="/indexp"><i class=""></i> Predio</a></li>
            <li><a href="/indextm"><i class=""></i> Tipo de mercancia</a></li>
            <li><a href="/indexm"><i class=""></i> Mercancia</a></li>
